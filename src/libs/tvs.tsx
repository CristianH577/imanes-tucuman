...
export const scrollStyle =
  "scrollbar scrollbar-thumb-rounded-full scrollbar-track-rounded-full scrollbar-thumb-custom1 scrollbar-track-custom2-10 scrollbar-w-2 scrollbar-h-2 hover:scrollbar-thumb-custom1-4";
