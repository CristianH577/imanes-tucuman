...
export default function UyA() {
  ...
  const tabs_ = [
    { label: "A saber", content: tabContent("asaber") },
    { label: "Utilidades", content: tabContent("utilidades") },
    { label: "Sujeción", content: tabContent("sujecion") },
    { label: "Ideas", content: tabContent("ideas") },
  ];

  return (
    <TabsCustom
      ariaLAbel="Panel de usos y aplicaciones"
      tabs={tabs_}
      classes={{
        contentWrapper: "flex flex-col items-center text-center",
