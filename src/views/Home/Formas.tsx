      ...
      >
        {items.map((item) => (
          <m.a
            ...
            className="bg-content1 rounded-lg p-4 sm:p-8 max-w-[400px] xs:min-h-[150px] max-h-[400px] flex items-center justify-center relative select-none group/item shadow-md"
          >
            <ImageCustom
              src={item.src}
              alt={`Iman ${item.label}`}
            ...
            />
            <b
              className="absolute text-3xl hidden text-center px-4 sm:px-8 text-white group-hover/item:block"
              style={{
