...
`,Ge=l.forwardRef(function(e,t){const a=le({props:e,name:"MuiTouchRipple"}),{center:i=!1,classes:o={},className:s,...p}=a,[u,d]=l.useState([]),f=l.useRef(0),h=l.useRef(null);l.useEffect(()=>{h.current&&(h.current(),h.current=null)},[u]);const M=l.useRef(!1),V=Le(),b=l.useRef(null),D=l.useRef(null),C=l.useCallback(c=>{const{pulsate:x,rippleX:R,rippleY:I,rippleSize:L,cb:U}=c;d(E=>[...E,$.jsx(_e,{classes:{ripple:y(o.ripple,g.ripple),rippleVisible:y(o.rippleVisible,g.rippleVisible),ripplePulsate:y(o.ripplePulsate,g.ripplePulsate),child:y(o.child,g.child),childLeaving:y(o.childLeaving,g.childLeaving),childPulsate:y(o.childPulsate,g.childPulsate)},timeout:Z,pulsate:x,rippleX:R,rippleY:I,rippleSize:L},f.current)]),f.current+=1,h.current=U},[o]),v=l.useCallback((c={},x={},R=()=>{})=>{const{pulsate:I=!1,center:L=i||x.pulsate,fakeElement:U=!1}=x;if((c==null?void 0:c.type)==="mousedown"&&M.current){M.current=!1;return}(c==null?void 0:c.type)==="touchstart"&&(M.current=!0);const E=U?null:D.current,B=E?E.getBoundingClientRect():{width:0,height:0,left:0,top:0};let S,T,w;if(L||c===void 0||c.clientX===0&&c.clientY===0||!c.clientX&&!c.touches)S=Math.round(B.width/2),T=Math.round(B.height/2);else{const{clientX:z,clientY:j}=c.touches&&c.touches.length>0?c.touches[0]:c;S=Math.round(z-B.left),T=Math.round(j-B.top)}if(L)w=Math.sqrt((2*B.width**2+B.height**2)/3),w%2===0&&(w+=1);else{const z=Math.max(Math.abs((E?E.clientWidth:0)-S),S)*2+2,j=Math.max(Math.abs((E?E.clientHeight:0)-T),T)*2+2;w=Math.sqrt(z**2+j**2)}c!=null&&c.touches?b.current===null&&(b.current=()=>{C({pulsate:I,rippleX:S,rippleY:T,rippleSize:w,cb:R})},V.start(Ye,()=>{b.current&&(b.current(),b.current=null)})):C({pulsate:I,rippleX:S,rippleY:T,rippleSize:w,cb:R})},[i,C,V]),A=l.useCallback(()=>{v({},{pulsate:!0})},[v]),F=l.useCallback((c,x)=>{if(V.clear(),(c==null?void 0:c.type)==="touchend"&&b.current){b.current(),b.current=null,V.start(0,()=>{F(c,x)});return}b.current=null,d(R=>R.length>0?R.slice(1):R),h.current=x},[V]);return l.useImperativeHandle(t,()=>({pulsate:A,start:v,stop:F}),[A,v,F]),$.jsx(He,{className:y(g.root,o.root,s),ref:D,...p,children:$.jsx(te,{component:null,exit:!0,children:u})})});function qe(n){return je("MuiButtonBase",n)}const Ze=ae("MuiButtonBase",["root","disabled","focusVisible"]),Je=n=>{const{disabled:e,focusVisible:t,focusVisibleClassName:a,classes:i}=n,s=ke({root:["root",e&&"disabled",t&&"focusVisible"]},qe,i);return t&&a&&(s.root+=` ${a}`),s},Qe=J("button",{name:"MuiButtonBase",slot:"Root"})({display:"inline-flex",alignItems:"center",justifyContent:"center",position:"relative",boxSizing:"border-box",WebkitTapHighlightColor:"transparent",backgroundColor:"transparent",outline:0,border:0,margin:0,borderRadius:0,padding:0,cursor:"pointer",userSelect:"none",verticalAlign:"middle",MozAppearance:"none",WebkitAppearance:"none",textDecoration:"none",color:"inherit","&::-moz-focus-inner":{borderStyle:"none"},[`&.${Ze.disabled}`]:{pointerEvents:"none",cursor:"default"},"@media print":{colorAdjust:"exact"}}),nt=l.forwardRef(function(e,t){const a=le({props:e,name:"MuiButtonBase"}),{action:i,centerRipple:o=!1,children:s,className:p,component:u="button",disabled:d=!1,disableRipple:f=!1,disableTouchRipple:h=!1,focusRipple:M=!1,focusVisibleClassName:V,LinkComponent:b="a",onBlur:D,onClick:C,onContextMenu:v,onDragLeave:A,onFocus:F,onFocusVisible:c,onKeyDown:x,onKeyUp:R,onMouseDown:I,onMouseLeave:L,onMouseUp:U,onTouchEnd:E,onTouchMove:B,onTouchStart:S,tabIndex:T=0,TouchRippleProps:w,touchRippleRef:z,type:j,...O}=a,X=l.useRef(null),m=ze(),ue=se(m.ref,z),[k,K]=l.useState(!1);d&&k&&K(!1),l.useImperativeHandle(i,()=>({focusVisible:()=>{K(!0),X.current.focus()}}),[]);const ce=m.shouldMount&&!f&&!d;l.useEffect(()=>{k&&M&&!f&&m.pulsate()},[f,M,k,m]);const pe=P(m,"start",I,h),de=P(m,"stop",v,h),fe=P(m,"stop",A,h),he=P(m,"stop",U,h),me=P(m,"stop",r=>{k&&r.preventDefault(),L&&L(r)},h),be=P(m,"start",S,h),ge=P(m,"stop",E,h),Me=P(m,"stop",B,h),Re=P(m,"stop",r=>{re(r.target)||K(!1),D&&D(r)},!1),xe=_(r=>{X.current||(X.current=r.currentTarget),re(r.target)&&(K(!0),c&&c(r)),F&&F(r)}),q=()=>{const r=X.current;return u&&u!=="button"&&!(r.tagName==="A"&&r.href)},Ee=_(r=>{M&&!r.repeat&&k&&r.key===" "&&m.stop(r,()=>{m.start(r)}),r.target===r.currentTarget&&q()&&r.key===" "&&r.preventDefault(),x&&x(r),r.target===r.currentTarget&&q()&&r.key==="Enter"&&!d&&(r.preventDefault(),C&&C(r))}),ye=_(r=>{M&&r.key===" "&&k&&!r.defaultPrevented&&m.stop(r,()=>{m.pulsate(r)}),R&&R(r),C&&r.target===r.currentTarget&&q()&&r.key===" "&&!r.defaultPrevented&&C(r)});let W=u;W==="button"&&(O.href||O.to)&&(W=b);const Y={};W==="button"?(Y.type=j===void 0?"button":j,Y.disabled=d):(!O.href&&!O.to&&(Y.role="button"),d&&(Y["aria-disabled"]=d));const Ce=se(t,X),ne={...a,centerRipple:o,component:u,disabled:d,disableRipple:f,disableTouchRipple:h,focusRipple:M,tabIndex:T,focusVisible:k},Te=Je(ne);return $.jsxs(Qe,{as:W,className:y(Te.root,p),ownerState:ne,onBlur:Re,onClick:C,onContextMenu:de,onFocus:xe,onKeyDown:Ee,onKeyUp:ye,onMouseDown:pe,onMouseLeave:me,onMouseUp:he,onDragLeave:fe,onTouchEnd:ge,onTouchMove:Me,onTouchStart:be,ref:Ce,tabIndex:d?-1:T,type:j,...Y,...O,children:[s,ce?$.jsx(Ge,{ref:ue,center:o,...w}):null]})});function P(n,e,t,a=!1){return _(i=>(t&&t(i),a||n[e](i),!0))}export{nt as B};
